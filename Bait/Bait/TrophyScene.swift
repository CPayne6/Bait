...
class TrophyScene: SKScene{
        ...
        let rightb = SKSpriteNode(imageNamed: "backr")
    
    override func didMoveToView(view: SKView) {
        
        
        rightb.position = CGPoint(x: self.size.width*0.9, y: self.size.height*0.35)
        rightb.zPosition = 2
        rightb.name = "rightButton"
        rightb.setScale(0.3)
